	...
	*/
	...
	function drawHeader($titleText,$mainURL,$current,$activeSession){
		...
		if($activeSession==null){
			...
			{
				$tab=array("Ingresar Modelo","Registra Auto","Renta a Clientes","Revisar Ventas","Registrar Servicios","Cerrar Sesión");
				$tabURL=array("altaModelo.php","altaAuto.php","renta.php","revisaVentas.php","altaServicios.php","cerrar.php");
			}
		}
